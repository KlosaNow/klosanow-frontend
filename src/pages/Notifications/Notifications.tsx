...
const notifications = [
	{name: "Jessi Akpa", action: "added you to a group", time: "Just Now", backgroundImageUrl: backgroundImage1},
	{name: "Seun Daniel", action: "added you to a group", time: "Just Now", backgroundImageUrl: backgroundImage2},
	{name: "", action: "You subscribed to the basic plan", time: "3 days ago", backgroundImageUrl: backgroundImage3},
	{name: "Timi Crown", action: "added you to a group", time: "4 days ago", backgroundImageUrl: backgroundImage4},
	{name: "", action: "You changed your password", time: "5 days ago", backgroundImageUrl: backgroundImage5},
	{name: "Idowu Taiwo", action: "added you to a group", time: "5 days ago", backgroundImageUrl: backgroundImage6},
]
