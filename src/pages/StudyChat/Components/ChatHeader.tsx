...
const ChatHeader = ({chatname} :headerProps) => {
    ...
    const ChatMenu = () => {
        return (
            <Flex display={isVisible ? "flex" : "none"} pos="absolute" top="60px" right="20px"
    ...
    return (
        <Flex position="absolute" top="0px" left="0px" right="0px" height="74px" bg="#F9F9F9" px="11px" py="16px" 
        justifyContent="space-between">
            ...
            <Flex justifyContent="center" alignItems="center" gap="8px">
                ...
                <IconButton aria-label="Menu" onClick={toggleMenu}  border="none" bg="none" fontSize="16px" size="xs" icon={<FiMoreVertical />} />
            </Flex>
            <ChatMenu />
        </Flex>
    )
